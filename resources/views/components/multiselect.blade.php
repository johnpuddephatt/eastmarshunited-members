...
<div>
  ...
  <div c x-data="dropdown()" x-init="loadOptions()">
    <input name="{{ $name }}" type="hidden" x-bind:value="selectedValues()">
    <div class="relative">
      <div class="relative flex flex-col items-center">
        <div x-on:click="open" class="w-full">
          <div
            class="flex p-0.5 my-2 border border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
            <div class="flex flex-wrap flex-auto">
              <template x-for="(option,index) in selected" :key="options[option].value">
                <div class="flex items-center justify-center px-2 py-1 m-1 font-medium bg-white border rounded-full ">
                  ...
                  <div class="flex flex-row-reverse flex-auto">
                    <div x-on:click="remove(index,option)">
                      <svg class="w-4 h-4 ml-1 fill-current " role="button" viewBox="0 0 20 20">
            ...
            <div class="flex items-center w-8 py-1 pl-2 pr-1 text-gray-300">
              ...
              <button type="button" x-on:click="isOpen() ? close : open"
          ...
          <div x-show.transition.origin.top="isOpen()"
            ...
            <div class="flex flex-col w-full">
              <template x-for="(option,index) in options" :key="option">
                <div>
                  <div class="w-full border-b border-gray-100 rounded-t cursor-pointer" @click="select(index,$event)">
      ...
      function dropdown() {
                return {
                    ...
                    loadOptions() {
                        ...
                        .filter((option) => {
                          return [{{implode(',',$value)}}].indexOf(parseInt(option.value)) !== -1;
                        })
                        .map((option) => {
